...
// UserDomainToDTO converts the given User from domain representation to
// DTO representation. Note that the returned representation will
// NEVER contain the password hash.
