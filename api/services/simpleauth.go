...
// SimpleAuth is an AuthenticationService which authenticates credentials based on a username
// and password combination. SimpleAuth uses a JWT as a token.
type SimpleAuth struct {
	tokenService *JWTService
}

// NewSimpleAuthService returns a new SimpleAuth which uses the given JWTService for generating and validating
// JWTs.
